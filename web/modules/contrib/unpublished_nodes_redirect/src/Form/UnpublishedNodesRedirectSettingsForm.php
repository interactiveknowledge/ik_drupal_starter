  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($content_types as $key => $type_name) {
      ...
      $form[$type_name][$key_name] = [
        '#type' => 'textfield',
        '#title' => $this->t('@type internal redirect path', ['@type' => $type_name]),
        '#description' => $this->t('Enter an internal redirect path for the @type content type.', ['@type' => $type_name]),
      ...
      $form[$type_name][$key_name] = [
        '#type' => 'select',
        '#title' => t('@type response code', ['@type' => $type_name]),
